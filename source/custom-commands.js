...
target.toLowerCase().replace(/ /g,'-');
	...
	shop: function(target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox('<div class = "Broadcast-black"><center><h4><b><u>The The Tsunami Shop</u></b></h4><table border="1" cellspacing="0" cellpadding="3"><tr><th>Items</th><th>Description</th><th>Cost</th></tr>' +
...
tournamentnote: function(target, room, user){
	...
	join: function(target, room, user, connection) {
		...
		if (target.toLowerCase() == "lobby") {
			return connection.sendTo('lobby','|html|<div class="Broadcast-red" border="5"><center><img src="http://i58.tinypic.com/2lj18o6.jpg"></center><br />' +
                                        '<center><b><font size="5">A Warm Welcome To Tsunami league!</b></font><br>' +       
                                        'Here At our server.We need some members for my league so if you want to join ask an admin(~)<br>' +
                                        'Well do you need any help with the the bot or welcome message pm a staff members(Driver(%),Moderator(@),Leader(&) or an admin(~))<br>' +
                                        'If you need anything or need help with a different server, feel free to pm Adipravar.<br>' +
                                        'We hope you have fun while you\'re here at the Tsunami  Server! If so, then please be sure to tell your friends about us!<br>All Thanks To Legit Button<br>' +
                                        '</u></b></center><br/><center><a href ="https://github.com/Adithya4Uberz/The-Tsunami-League"><b>This Server is hosted By Adipravar</b></a></center><br/><br/> ' +
                                        '<hr width="85%">' +
                                        '<center><a href="http://tsunamireborn.weebly.com/"><button class="blackbutton" title="Site"><font color="red"><b>Site</b></a></button> ' +
                                        '</div>');
		}
